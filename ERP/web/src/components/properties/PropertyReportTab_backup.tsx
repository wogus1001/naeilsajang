...
import { Printer, Check, ChevronDown, Layout, FileText, PieChart, ArrowLeft } from 'lucide-react';
...
const PropertyReportTab: React.FC<PropertyReportTabProps> = ({ data, onChange, onSave }) => {
