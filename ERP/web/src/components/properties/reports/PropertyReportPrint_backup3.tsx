...
const PropertyReportPrint: React.FC<PropertyReportPrintProps> = ({ data, format }) => {
    ...
    const renderFormat1 = () => (
        <>
            ...
            {/* 1. Overview & Scale */}
            <div className="print-grid print-section" style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '20px', marginBottom: '20px', marginTop: '10px' }}>
                <div>
            ...
            <div className="print-grid print-section" style={{ display: 'grid', gridTemplateColumns: '1.15fr 1.15fr 0.7fr', gap: '20px', marginBottom: '20px' }}>
                {/* Price Info */}
                <div>
                    <h2 style={{ fontSize: '19px', borderLeft: '4px solid #fcc419', paddingLeft: '10px', marginBottom: '15px', color: '#333' }}>금액 정보</h2>
                ...
                {/* Franchise Cost */}
                <div>
                    <h2 style={{ fontSize: '19px', borderLeft: '4px solid #f76707', paddingLeft: '10px', marginBottom: '15px', color: '#333' }}>프랜차이즈 비용</h2>
                    <table className="report-table" style={{ width: '100%', tableLayout: 'fixed' }}>
                        <colgroup>
                            <col style={{ width: '25%' }} />
                            <col style={{ width: '25%' }} />
            ...
            <div className="print-grid print-section" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px', marginBottom: '30px' }}>
                <div>
            ...
            <div className="print-grid print-section" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '30px' }}>
                <div>
            ...
            <div className="print-section" style={{ marginBottom: '10px' }}>
                <h2 style={{ fontSize: '19px', borderLeft: '4px solid #228be6', paddingLeft: '10px', marginBottom: '15px', color: '#333' }}>임대차 메모</h2>
                <div className="memo-box memo-box-large" style={{ ...getBoxStyle('100px', 5), backgroundColor: '#e7f5ff', borderColor: '#d0ebff' }}>
                    {data.leaseMemo || '-'}
                </div>
            </div>
    ...
    const renderFormat2 = () => (
        <>
            ...
            <div className="print-section" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px', marginBottom: '15px', marginTop: '5px', alignItems: 'stretch' }}>
                <div>
                    <h2 style={{ fontSize: '19px', borderLeft: '4px solid #333', paddingLeft: '10px', marginBottom: '15px', color: '#333' }}>물건 개요</h2>
            ...
            <div className="print-section" style={{ marginBottom: '15px' }}>
                ...
                <div className="memo-box memo-box-medium" style={{ ...getBoxStyle('75px', 5), backgroundColor: '#f8f9fa' }}>{data.overviewMemo || '-'}</div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', marginBottom: '10px' }}>
                <div className="print-section no-print-margin">
                    ...
                    <div className="memo-box memo-box-large" style={{ ...getBoxStyle('95px', 5), backgroundColor: '#f4fce3', borderColor: '#d8f5a2' }}>{data.operationMemo || '-'}</div>
                </div>
                <div className="print-section no-print-margin">
                    <h2 style={{ fontSize: '19px', borderLeft: '4px solid #228be6', paddingLeft: '10px', marginBottom: '15px', color: '#333' }}>임대차권리 메모</h2>
                    <div className="memo-box memo-box-large" style={{ ...getBoxStyle('95px', 5), backgroundColor: '#e7f5ff', borderColor: '#d0ebff' }}>{data.leaseMemo || '-'}</div>
                </div>
            </div>
        </>
    );
        ...
        return (
            <>
                ...
                <div style={{ height: '300px', marginTop: '20px' }}>
                    ...
                    <div style={{ width: '100%', height: '260px', backgroundColor: '#f8f9fa', borderRadius: '4px', padding: '10px' }}>
                        {typeof window !== 'undefined' && (
                            <ResponsiveContainer width="100%" height="100%">
                                <ComposedChart data={monthlyHistoryData} margin={{ top: 20, right: 30, left: 20, bottom: 30 }}>
                                    <CartesianGrid strokeDasharray="3 3" vertical={false} />
                                    <XAxis dataKey="name" fontSize={12} tickLine={false} axisLine={false} />
                                    <YAxis fontSize={12} tickLine={false} axisLine={false} tickFormatter={(value) => `${value / 10000}만`} width={40} />
                                    <Bar dataKey="cash" name="현금" stackId="a" fill="#1c7ed6" barSize={20} />
                                    <Bar dataKey="card" name="카드" stackId="a" fill="#37b24d" barSize={20} />
                                    <Line type="monotone" dataKey="total" name="총매출" stroke="#fab005" strokeWidth={3} dot={{ r: 4, fill: '#fab005' }} activeDot={{ r: 6 }} />
                                </ComposedChart>
                            </ResponsiveContainer>
                        )}
                    </div>
